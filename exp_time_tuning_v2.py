        ...
        for epoch in range(self.num_epochs):
            ...
            if self.spair_val:
                ...
                if recall > self.best_recall:
                    ...
                    save_path = os.path.join(checkpoint_dir, f"FINAL_model_best_recall_epoch_{epoch}_{self.time_tuning_model.model_type}_{self.time_tuning_model.training_set}_asta_e_reg_submit.pth")
    ...
    def validate(self, epoch, val_spatial_resolution=56):
        ...
        with torch.no_grad():
            ...
            if jac > self.best_miou: #self.best_miou:
                ...
                save_path = os.path.join(checkpoint_dir, f"FINAL_model_best_miou_epoch_{epoch}_{self.time_tuning_model.model_type}_{self.time_tuning_model.training_set}_asta_e_reg_submit.pth")
            ...
            save_path_latest = os.path.join(checkpoint_dir, f"FINAL_latest_model_{self.time_tuning_model.model_type}_{self.time_tuning_model.training_set}_asta_e_reg_submit.pth")
